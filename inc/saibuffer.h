...
typedef struct _sai_buffer_api_t
{
    ...
    sai_bulk_object_create_fn                       bulk_create_ingress_priority_groups;
    sai_bulk_object_remove_fn                       bulk_remove_ingress_priority_groups;
    sai_bulk_object_set_attribute_fn                bulk_set_ingress_priority_groups_attribute;
    sai_bulk_object_get_attribute_fn                bulk_get_ingress_priority_groups_attribute;
} sai_buffer_api_t;
